...
public class BugAdapterMyBugs extends RecyclerView.Adapter<BugAdapterMyBugs.MyViewHolder> {

    private Context mContext;
    private ArrayList<Bug> bugList;


    public BugAdapterMyBugs(Context context, ArrayList<Bug> bugList) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.bug_list_item_mybugs,parent,false);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(mContext, BugDetailsActivityMyBugs.class);
