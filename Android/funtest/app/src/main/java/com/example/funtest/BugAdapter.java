...
public class BugAdapter extends RecyclerView.Adapter<BugAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        //String currentExecs = bugList.get(position).getRetestsRequired() + "/" + bugList.get(position).getRetestsDone() + "/" + bugList.get(position).getRetestsFailed();
        //holder.bugExecs.setText(currentExecs);
