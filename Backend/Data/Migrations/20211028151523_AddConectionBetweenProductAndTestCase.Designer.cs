...
namespace Data.Migrations
{
    ...
    [Migration("20211028151523_AddConectionBetweenProductAndTestCase")]
    partial class AddConectionBetweenProductAndTestCase
    {
            ...
            modelBuilder.Entity("Data.Models.Error", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("03562429-5371-4c2a-aab5-c73391f4a09d"),
                            ...
                            ErrorType = 0,
                            Name = "Bug #1",
                            ReportDate = new DateTime(2021, 10, 28, 0, 0, 0, 0, DateTimeKind.Local),
                            RetestsRequired = 2,
                        ...
                        new
                        {
                            Id = new Guid("0f16365f-0292-45f4-8388-7430ec5f2de9"),
                            Category = "Functional",
                            Code = "B-2434343",
                            Deadline = new DateTime(2021, 12, 20, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Description = "Error description",
                        ...
                        new
                        {
                            Id = new Guid("a17537e0-5246-4f33-99ea-87973e44ead2"),
                            Category = "UX",
                            Code = "B-2434343",
                            Deadline = new DateTime(2021, 12, 20, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Description = "Error description",
                        ...
                        new
                        {
                            Id = new Guid("af94b298-bb63-4290-8e13-c12f3cec7ac1"),
                            Category = "Database",
                            Code = "B-2434343",
                            Deadline = new DateTime(2021, 12, 20, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Description = "Error description",
                        ...
                        new
                        {
                            Id = new Guid("070100fd-6f2a-4275-a525-e11858e8ddd1"),
                            Category = "Database",
                            Code = "B-2434343",
                            Deadline = new DateTime(2021, 12, 20, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Description = "Error description",
                        ...
                        new
                        {
                            Id = new Guid("473fa2b2-f2ab-48b2-a0c7-6fb8cb4489ff"),
                            Category = "Database",
                            Code = "B-2434343",
                            Deadline = new DateTime(2021, 12, 20, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Description = "Error description",
