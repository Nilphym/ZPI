...
const routes = [
  ...
  (thisRef) =>
    thisRef.get('Product/:productId/TestPlans', (schema, request) => {
      ...
      const { testPlans } = schema.products.findBy({
        id: productId
      }).attrs;
      return testPlans;
    }),
  ...
  (thisRef) =>
    thisRef.post('TestSuites', (schema, request) => {
      ...
      const { testSuites } = schema.testPlans.findBy({
        id: testPlanId
      }).attrs;
  ...
  (thisRef) =>
    thisRef.post(':productId/TestPlans', (schema, request) => {
      ...
      const { testPlansIds } = schema.products.findBy({
        id: productId
      }).attrs;
  ...
  (thisRef) =>
    thisRef.put('Tests/:id', (schema, request) => {
      const { id } = request.params;
      const { name, selectedTestSuiteId, selectedTestProcedureId, selectedTestCaseId } = JSON.parse(
        request.requestBody
      );
      schema.tests
        .findBy({
  ...
  (thisRef) =>
    thisRef.post('Tests', (schema, request) => {
      ...
      const { planTestId: testPlanId, planSuiteId, name } = JSON.parse(request.requestBody);
      const { testsIds } = schema.testPlans.findBy({
        id: testPlanId
      }).attrs;
      schema.testPlans
        .findBy({
  ...
  (thisRef) =>
    thisRef.post('TestProcedures', (schema, request) => {
      ...
      const { testProceduresCodes } = schema.tests.findBy({
        id: testId
      }).attrs;
      schema.tests
        .findBy({
  ...
  (thisRef) =>
    thisRef.post('TestCases', (schema, request) => {
      ...
      const { testId } = JSON.parse(request.requestBody);
      const { testCasesCodes } = schema.tests.findBy({
        id: testId
      }).attrs;
  ...
  (thisRef) =>
    thisRef.post('Steps', (schema, request) => {
      ...
      const { testStepsIds } = schema.testProcedures.findBy({
        id
      }).attrs;
      schema.testProcedures
        .findBy({
